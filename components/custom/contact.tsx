...
const Contact = () => {
  return (
    <div 
      id="contact"
      className="bg-[#191919] justify-between items-start w-full flex flex-col
        mobile:px-3 mobile:py-5 mobile:gap-4
        tablet:px-36 tablet:mt-5 tablet:py-7
        laptop:px-64 laptop:mt-7 laptop:py-12
        desktop:px-96
      "
    >
      <h1 
      ...
      <div className="flex flex-col mobile:gap-1.5">
        ...
        <p 
          className="
            flex items-center text-secondary-text font-light 
            mobile:gap-2 mobile:text-[0.6rem] 
            laptop:text-[0.8rem]
          "
        >
          <Mail 
